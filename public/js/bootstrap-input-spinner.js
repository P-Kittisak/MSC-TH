    ...
    $.fn.inputSpinner = function (methodOrProps) {
        ...
        var props = {
            ...
            template: // the template of the input
                ...
                '<button style="min-width: ${buttonsWidth}" class="btn btn-decrement ${buttonsClass} btn-minus" type="submit">${decrementButton}</button>' +
                '<input type="text" inputmode="decimal" style="text-align: ${textAlign}; width:45px;" class="form-control form-control-text-input"/>' +
                '<button style="min-width: ${buttonsWidth}" class="btn btn-increment ${buttonsClass} btn-plus" type="submit">${incrementButton}</button>' +
                '</div>'
        }
